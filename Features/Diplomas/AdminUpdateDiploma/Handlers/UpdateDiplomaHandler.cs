...
{
    public class UpdateDiplomaHandler : IRequestHandler<UpdateDiplomaCommand, RequestResponse<Unit>>
    {
...

        {
            ...
            {
               return RequestResponse<Unit>.Fail("Diploma not found" , 400);
            }
            ...
            return RequestResponse<Unit>.Ok(Unit.Value , "Diploma Updated Successfully" , 200);
